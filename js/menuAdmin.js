...
function changeEdit(action, id) {
	if(action == 1) {
		document.getElementById(id).src = '../pictures/system/editHover.png';
	}
	if(action == 0) {
		document.getElementById(id).src = '../pictures/system/edit.png';
	}
}

function admPointChange(action, point, font, section) {
	if(action == 1) {
		document.getElementById(point).style.backgroundColor = '#dddddd';
		document.getElementById(font).style.color = '#df4e47';
		document.getElementById(section).style.backgroundColor = '#df4e47';
	}
...
function admPointChangeD2(action, point, font, section, drop) {
	if(action == 1) {
		document.getElementById(point).style.backgroundColor = '#dddddd';
		document.getElementById(font).style.color = '#df4e47';
		document.getElementById(section).style.backgroundColor = '#df4e47';

		var x = jQuery('#admPoint2').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
...
function admPointChangeAD2(action, drop) {
	if(action == 1) {
		var x = jQuery('#admPoint2').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
...
function admPointChangeD3(action, point, font, section, drop) {
	if(action == 1) {
		document.getElementById(point).style.backgroundColor = '#dddddd';
		document.getElementById(font).style.color = '#df4e47';
		document.getElementById(section).style.backgroundColor = '#df4e47';

		var x = jQuery('#admPoint3').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
		document.getElementById(drop).style.display = 'block';
	}
...
function admPointChangeAD3(action, drop) {
	if(action == 1) {
		var x = jQuery('#admPoint3').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
...
function admPointChangeD4(action, point, font, section, drop) {
	if(action == 1) {
		document.getElementById(point).style.backgroundColor = '#dddddd';
		document.getElementById(font).style.color = '#df4e47';
		document.getElementById(section).style.backgroundColor = '#df4e47';

		var x = jQuery('#admPoint4').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
		document.getElementById(drop).style.display = 'block';
	}
...
function admPointChangeAD4(action, drop) {
	if(action == 1) {
		var x = jQuery('#admPoint4').offset().left;
		document.getElementById(drop).style.left = x + 'px';
		document.getElementById(drop).style.zIndex = '1000';
