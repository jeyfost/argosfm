                                                ...
                                                while($address = $mailResult->fetch_assoc())
                                                {
                                                    ...
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td class='adminTDName'"; if($count % 2 == 0) {echo " style='background-color: #dddddd;'";} echo " onclick='editName(\"".$address['id']."\", \"".$mysqli->real_escape_string(str_replace("&quot;", "\"", $address['name']))."\", \"nameBlock".$address['id']."\")'>
                                                                <div id='nameBlock".$address['id']."'><span class='admULFont' style='cursor: pointer;' onclick='editName(\"".$address['id']."\", \"".$mysqli->real_escape_string(str_replace("&quot;", "\"", $address['name']))."\", \"nameBlock".$address['id']."\")' title='Редактировать имя / название организации'>".$address['name']."</span></div>
                                                            </td>
