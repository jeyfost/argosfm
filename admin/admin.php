                                                ...
                                                while($address = $mailResult->fetch_assoc())
                                                {
                                                    ...
                                                    echo "
                                                        <tr>
                                                            ...
                                                            <td class='adminTDMail'"; if($count % 2 == 0) {echo " style='background-color: #dddddd;'";} echo ">
                                                                <div id='emailBlock".$address['id']."'><span class='admULFont' style='cursor: pointer;' onclick='editEmail(\"".$address['id']."\", \"emailBlock".$address['id']."\")' title='Редактировать e-mail'>".$address['email']."</span></div>
                                                            </td>
                                                            <td class='adminTDName'"; if($count % 2 == 0) {echo " style='background-color: #dddddd;'";} echo " onclick='editName(\"".$address['id']."\", \"nameBlock".$address['id']."\")'>
                                                                <div id='nameBlock".$address['id']."'><span class='admULFont' style='cursor: pointer;' title='Редактировать имя / название организации'>".$address['name']."</span></div>
                                                            </td>
                                                            <td class='adminTDPhone'"; if($count % 2 == 0) {echo " style='background-color: #dddddd;'";} echo " onclick='editPhone(\"".$address['id']."\", \"phoneBlock".$address['id']."\")'>
                                                                <div id='phoneBlock".$address['id']."'><span class='admULFont' style='cursor: pointer;' title='Изменить номер телефона'>".$address['phone']."</span></div>
                                                            </td>
