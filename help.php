            ...
            if($_SESSION['userID'] == 1) {
                if(empty($_REQUEST['section'])) {
                    ...
                    switch($_REQUEST['section']) {
                        ...
                        case "42":
                            echo "
                                <h2 class='goodStyle'>Страница опубликованных новостей</h2>
                                <p><a href='help.php' class='noBorder'><span class='catalogueItemTextItalic'>Помощь</span></a><span class='catalogueItemTextItalicNoHover'> > </span><a href='help.php?section=42' class='noBorder'><span class='catalogueItemTextItalic'>Страница опубликованных новостей</span></a></p>
                                <div class='helpBlock'><p><a href='pictures/help/admin_news.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>Страница опубликованных новостей</span></a> представляет собой таблицу, содержащую заголовки опубликованных новостей с датой публикации и панель поиска новостей.</div>
                                <div class='helpBlock'><p>При нажатии на заголовок новости вы попадёте на <a href='pictures/help/admin_news_edit.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>страницу редактирования новости</span></a>. Подробнее о редактировании новостей читайте в <a href='help.php?section=18' class='noBorder' target='_blank'><span class='basicRed' style='font-size: 14px;'>этой ветке</span></a>.</div>
                                <div class='helpBlock'><p>Для поиска новости начните вводить её название в поле для поиска. В процессе ввода в <a href='pictures/help/admin_news_search_list.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>появившемся блоке</span></a> вам будут предложены различные новости с названиями, схожими с поисковым запросом. Если вы ненадолго задержите курсор на названии новости, вы увидете во всплывающей подсказке её краткое описание.По завершении поиска выберите нужную новость и нажмите на неё. После нажатия вас перенаправит на <a href='pictures/help/admin_news_edit.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>страницу редактирования</span></a> выбранной новости.</div>
                            ";
                            break;
                        default:
                            echo "
