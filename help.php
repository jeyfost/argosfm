                    ...
                    switch($_REQUEST['section']) {
                        ...
                        case "31":
                            echo "
                                ...
                                <div class='helpBlock'><p>Для отправления рассылки всем клиентам из определённой области необходимо выбрать пункт \"<b>Отправить всем из выбранной области</b>\". Ниже появится <a href='pictures/help/admin_email_group.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>выпадающий список с областями</span></a>. По умолчанию выбрана Могилёвская область. После выбора области необхоимо написать тему рассылки и её текст. Если необходимо, можно добавить неограниченное число файлов любых типов, нажав на кнопку \"<b>Выбрать файлы</b>\".</p></div>
