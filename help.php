                    ...
                    switch($_REQUEST['section']) {
                        ...
                        case "2":
                            echo "
                                ...
                                <div class='helpBlock'><p>Гости и авторизованные пользователи видят каталог по-разному. <a href='pictures/help/catalogue_content.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>Так страницу каталога видит авторизованный пользователь</span></a>, а <a href='pictures/help/catalogue_guest.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>так её видит </span></a>. Преимуществом зарегистрированных пользователей является возможность добавлять товары в корзину и оформлять онлайн-заказы.</p></div>
