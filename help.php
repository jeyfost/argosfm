                    ...
                    switch($_REQUEST['section']) {
                        ...
                        case "40":
                            echo "
                                ...
                                <div class='helpBlock'><p>Для поиска пользователя по логину воспользуйтесь <a href='pictures/help/admin_users_search.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>блоком быстрого поиска</span></a>, который расположен в верхней правой части <a href='pictures/help/admin_users.jpg' class='noBorder' rel='lightbox'><span class='basicBlue'>страницы управления пользователями</span></a>. При вводе вам будут предлагаться похожие варианты в появишемся блоке. Если искомый логин есть в появившемся поле, значит пользователь с таким логином сушествует. Для редактирования или просмотра его личных данных нажмите на логин.</p></div>
                            ";
                            break;
                        case "41":
                            break;
