                    ...
                    switch($_REQUEST['section']) {
                        ...
                        case "2":
                            echo "
                                ...
                                <div class='helpBlock'>
                                    <p>Страница каталога <a href='index.php' target='_blank' class='noBorder'><span class='basicRed' style='font-size: 14px;'>Аргос-ФМ</span></a> состоит из трёх двух блоков:</p>
                                    <ol>
