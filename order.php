            	...
            	<?php
					...
					else
					{
						...
						{	
							...
							{
								echo "
									<a href='order.php' class='noBorder'><img src='pictures/system/basketRed.png' class='noBorder' id='basketIcon' title='Корзина' /></a>
								";
							}
							else
							{
						...
						else
						{
							...
							{
								echo "
									<a href='order.php' class='noBorder'><img src='pictures/system/basketRed.png' class='noBorder' id='basketIcon' title='Заявки' /></a>
								";
							}
							else
							{
