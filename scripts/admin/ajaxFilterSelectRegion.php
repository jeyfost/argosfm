...
echo "<br /><br /><label class='admLabel'>".iconv('cp1251', 'utf8', "Выберите область:")."</label><br /><select class='admSelect' name='regionSelect' id='regionSelect' onchange='selectRegionFilter()'><option value='all' selected>".iconv("cp1251", "utf8", "Все области")."</option>";
