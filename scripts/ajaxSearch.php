			...
			while($search = $searchResult->fetch_assoc())
			{
				...
				echo "
					<div class='searchLine'"; if($count != 1) {echo " style='margin-top: 10px;'";} echo ">
						...
						<br /><br />
						<div class='pictureSmall'><a href='pictures/catalogue/big/".$search['picture']."' class='noBorder' rel='lightbox'><img src='pictures/catalogue/small/".$search['small']."' class='noBorder' style='width: 30px; height: 30px;' /></a></div>
